            ...
            <div class="row gx-0 align-items-center">
                <div class="col-lg-8 text-center text-lg-start mb-2 mb-lg-0">
                    <div class="d-flex flex-wrap">
                        ...
                        <a href="mailto:example@gmail.com" class="text-muted small me-0"><i class="fas fa-envelope text-primary me-2"></i>contacto@tecland.com.mx</a>
                    </div>
                </div>
                <div class="col-lg-4 text-center text-lg-end">
                    <div class="d-inline-flex align-items-center" style="height: 45px;">
                        <a style="display: none;" href="#"><small class="me-3 text-dark"><i class="fa fa-user text-primary me-2"></i></small></a>
                        <a style="display: none;" href="#"><small class="me-3 text-dark"><i class="fa fa-sign-in-alt text-primary me-2"></i></small></a>
                        <div class="dropdown" style="display: none">
                            <a href="#" class="dropdown-toggle text-dark" data-bs-toggle="dropdown"><small><i class="fa fa-home text-primary me-2"></i></small></a>
        ...
        <div class="container-fluid position-relative p-0">
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                <a href="" class="navbar-brand p-0">
                    {{-- <h1 class="text-primary"><i class="fas fa-search-dollar me-3"></i>Tecland</h1> --}}
                    ...
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu m-0">
                                <a href="feature.html" class="dropdown-item">Electrica</a>
                                <a href="team.html" class="dropdown-item">Hidraulica</a>
                                <a href="testimonial.html" class="dropdown-item">Neumatica</a>
                                <a href="offer.html" class="dropdown-item">Procesos</a>
                                <a href="FAQ.html" class="dropdown-item">Sensores</a>
            ...
            <div class="header-carousel owl-carousel">
                <div class="header-carousel-item">
                    <img src="img/categories/electric.jpeg" class="img-fluid w-100" alt="Image">
                            ...
                            <div class="row gy-0 gx-5">
                                ...
                                <div class="col-xl-7 animated fadeInLeft">
                                    <div class="text-sm-center text-md-end">
                                        {{-- <h4 class="text-primary text-uppercase fw-bold mb-4">Bienvenido a  Tecland</h4> --}}
                                        <h1 class="display-4 text-uppercase text-white mb-4">Bienvenido a Tecland</h1>
                                        <p class="mb-5 fs-5">
                                        Tecland ofrece insumos industriales de alta calidad, especializados en productos eléctricos, hidráulicos, neumáticos, de procesos y sensores. Garantizamos la mejor tecnología y servicio.
                                        </p>
                ...
                <div class="header-carousel-item">
                    <img src="img/categories/hidraulic.jpg" class="img-fluid w-100" alt="Image">
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row gy-0 gx-5">
                                <div class="col-lg-0 col-xl-5"></div>
                ...
                <div class="header-carousel-item">
                    <img src="img/categories/neumatic.jpg" class="img-fluid w-100" alt="Image">
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row gy-0 gx-5">
                                <div class="col-lg-0 col-xl-5"></div>
                ...
                <div class="header-carousel-item">
                    <img src="img/categories/process.jpeg" class="img-fluid w-100" alt="Image">
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row gy-0 gx-5">
                                <div class="col-lg-0 col-xl-5"></div>
                ...
                <div class="header-carousel-item">
                    <img src="img/categories/sensors.jpg" class="img-fluid w-100" alt="Image">
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row gy-0 gx-5">
                                <div class="col-lg-0 col-xl-5"></div>
